...
const { Label, AxisPointer, Title, Tooltip, Legend, Grid, XAxis, YAxis, Series } = Components
  ...
  return (
    <div className="line-chart-box">
      <Recharts>
        ...
        <Series name="直接访问" type="line" stack="总量" areaStyle={{}} data={[320,332,301,334,390,330,320]} />
        <Series name="搜索引擎" type="line" stack="总量" areaStyle={{}} data={[820,932,901,934,1290,1330,1320]}> <Label normal={{"show":true,"position":"top"}} /> </Series>
      </Recharts>
    </div>
  )
}
